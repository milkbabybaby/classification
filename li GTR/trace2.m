...
x0=WW'*AA';         % 第一二类样本在二维上的投影

 
plot(x0(1,1:50) ,x0(2,1:50),x0(3,1:50),'r*')   
hold on
plot3(x0(1,51:100),x0(2,51:100),x0(3,51:100),'bo')
 hold on
plot3(x0(1,101:150),x0(2,101:150),x0(3,101:150),'k^')
legend('Setosa', 'Versicolor','Virginica')
 
% plot3(x0(1,1:50) ,x0(2,1:50),x0(3,1:50),'r*')   
% hold on
% plot3(x0(1,51:100),x0(2,51:100),x0(3,51:100),'bo')
%  hold on
% plot3(x0(1,101:150),x0(2,101:150),x0(3,101:150),'k^')
