...
de_value=100; % reduced dimension everytime 
MM=floor(no_fea/de_value); % the number of the layers
n1=no_fea;
M=no_fea;

%%%   MM-1 layer
%%%   dimension can be reduced to  no_fea(original dimension)-de_value*(MM-1)
...
%%%%%%% the last layer and assign reduced dimension M
